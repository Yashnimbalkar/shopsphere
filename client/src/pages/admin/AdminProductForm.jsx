...
const emptyForm = {
  ...
  price: '', originalPrice: '', stockQuantity: '', image: '',
}
...
function AdminProductForm() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">{isEdit ? 'Edit' : 'Add'} Product</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="number" step="0.01" name="originalPrice" value={form.originalPrice} onChange={handleChange}
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input name="image" value={form.image} onChange={handleChange} placeholder="🎧"
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm" />
          </div>
        </div>
